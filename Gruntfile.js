...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    // This task will compile all less files upon saving to create both VPI.css and VPI.min.css
    less: {
      ...
      development: {
        ...
        files: {
          ...
          "dist/css/VPI.css": "build/less/VPI.less",
      ...
      production: {
        ...
        files: {
          // compilation.css  :  source.less
          "dist/css/VPI.min.css": "build/less/VPI.less",
          // Skins minified
    ...
    cssjanus: {
      build: {
        files: {
          'dist/css/VPI-rtl.css': 'dist/css/VPI.css',
          'dist/css/VPI-rtl.min.css': 'dist/css/VPI.min.css',
